...
namespace SG_Constancia_TSC
{
    public partial class Autorizar_Constancia : System.Web.UI.Page
    {
        ...
        private void LoadStatuses()
        {
            ...
            string query = "SELECT Id_Estado, Descripcion_Estado FROM Estados WHERE Id_Estado IN (7)";
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    void OpenReport(string nombreParametro)
                    {
                      ...
                      <p style='margin-bottom:0pt;'>La presente constancia tiene validez por el término de seis meses.</p>
                            ...
                            //byte[] firmaBytes = ObtenerFirma(solicitudId); // parametro.Id = código_parametro en tu tabla
                                                                           // 1. Obtener firma desde BD
                            ...
                            ActualizarEstado(solicitudId, 7, "Constancia generada y revisada.");

                            string scriptBandeja = @"
                             Swal.fire({
                               icon: 'success',
                               title: '¡Éxito!',
                                   text: 'La constancia se ha enviado a la bandeja de Solicitudes Generadas.',
        ...
        INSERT INTO ConstanciasEntregadas (
            ...
            string updateQuery = @"
        UPDATE Constancias
        SET ArchivoConstanciaSecretaria = @Archivoconstancia, Estado = 7, Observaciones = 'Constancia fue generada y revisada , proceda a descargar'

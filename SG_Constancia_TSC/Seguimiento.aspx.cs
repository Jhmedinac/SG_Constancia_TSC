...
namespace SG_Constancia_TSC
{
    public partial class Seguimiento : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack || Request.UrlReferrer == null || Request.HttpMethod == "GET")
            {
                LimpiarCampos();
            }
        ...
        protected void btnEnviarCodigo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    MostrarAlertaSwal("Alerta", "Por favor, ingrese el correo electrónico utilizado para realizar su solicitud.", "warning");
                //    return;
                //}
    ...
    ", true);
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                MostrarAlertaSwal("¡Error!", "Código de verificación incorrecto.", "error");
               
                RegistrarScriptOcultarMensaje(); // Limpieza del mensaje en 20 seg.
                return;
            }

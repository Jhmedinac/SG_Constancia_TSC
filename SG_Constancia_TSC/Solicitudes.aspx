...
<CellStyle HorizontalAlign="Center" Font-Size="Small"></CellStyle>
    ...
    <Styles>
        ...
        <FocusedRow BackColor="White" />
          ...
          <asp:SqlDataSource runat="server" ID="SqlDataUsers" ConnectionString='<%$ ConnectionStrings:connString %>' SelectCommand="SELECT * FROM [V_Usuarios] where Estado in (1,2,3) ORDER BY Id DESC"></asp:SqlDataSource>

            ...
            <dx:ASPxFormLayout runat="server" ID="formSeguimientoConstancia" CssClass="formLayout">
                ...
                <Items>
                    <dx:LayoutItem ShowCaption="False" HorizontalAlign="Left">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <table>
                                    <tr>
                                        <td><strong>Bienvenido al seguimiento de solicitud de constancia de no tener cuentas pendientes con el Estado de Honduras,
                                            por favor llenar los siguientes campos para realizar la consulta.</strong>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                    ...
                    <dx:LayoutGroup Caption="Paso 2: Búsqueda Directa" ColCount="2">
                        <Items>
                            <dx:LayoutItem Caption="Código Seguro de Verificación(CSV):">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txtCodigo" runat="server" ClientInstanceName="txtCodigo" AutoPostBack="false" NullText="CSV" ToolTip="Ingrese el CSV para verificar la legitimidad de su constancia.">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content p-4" style="border-radius: 12px;">
                        ...
                        <div class="modal-body" id="popupBodyContent">
                            <!-- Aquí se mostrará el contenido desde el servidor -->
                        </div>
                    </div>
                </div>
            </div>

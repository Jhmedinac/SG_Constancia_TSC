...
<%--                  <EditForm BackColor="#def7ff">
     ...
     <asp:SqlDataSource ID="SqlDataSource_Codigo_roles" runat="server" ConnectionString="<%$ ConnectionStrings:connString %>" SelectCommand="SELECT [Id], [Name] 
FROM [AspNetRoles]
"></asp:SqlDataSource>
          </div>
         <asp:SqlDataSource ID="SqlDataSourceUser" runat="server" ConnectionString='<%$ ConnectionStrings:connString %>' SelectCommand="SELECT AspNetUsers.Id, AspNetUsers.UserName, AspNetUsers.Puesto, AspNetUsers.Email, AspNetUsers.EmailConfirmed, AspNetUsers.LockoutEnabled, AspNetUsers.Nombre_Usuario, R.RoleId FROM AspNetUsers LEFT OUTER JOIN AspNetUserRoles AS R ON AspNetUsers.Id = R.UserId
"

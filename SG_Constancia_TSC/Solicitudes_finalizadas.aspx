...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    <asp:Panel ID="Panel_Content" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowPopup() {
                ...
                if (grid) {
                    ...
                    if (focusedRowIndex !== -1) {
                        ...
                        Swal.fire({
                            title: "¡Alerta!",
                            text: "Por favor genere la constancia antes de actualizar el estado.",
                            icon: "warning",
            ...
            function onPopupUpdateCallbackComplete(s, e) {
                ...
                if (status === 'OK') {
                    ...
                    // Si vino la marca de CLEAR, limpia/oculta el viewer
                    if (flag === 'CLEAR') {
                        // 1. Si estás mostrando un reporte, reemplázalo por uno vacío vía callback al servidor:
                        //    Llamamos a un método que cargue un reporte vacío. Si no quieres servidor, simplemente ocultas:
                        ...
                        // Opcional: si puedes, fuerza abrir un reporte vacío desde servidor
                        // (o recarga el viewer en blanco de la forma que tu app lo soporte)
                    }
                } else {
                    Swal.fire({
                        icon: 'error',
                    ...
                    <dx:GridViewToolbar>
                        ...
                        <Items>
                            ...
                            <dx:GridViewToolbarItem Command="Custom">
                                <Template>
                                    <dx:ASPxButton ID="ASPxReportCosntancia" runat="server" Text="Generar Constancia" AutoPostBack="False" CssClass="btn-accion" OnClick="ASPxReportCosntancia_Click">
                                    </dx:ASPxButton>
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataUsers" ConnectionString='<%$ ConnectionStrings:connString %>' SelectCommand="SELECT DISTINCT Id, Identidad, FirstName, LastName, NumRtn, NomInstitucion, TipoSolicitud, Email, Descripcion_Estado, Phone,
            FechaIngreso, FechaTermino, Id_Estado, IdRole, Observaciones FROM V_Solicitudes WHERE (Id_Estado IN (6)) 

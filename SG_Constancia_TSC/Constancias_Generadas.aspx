...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    <asp:Panel ID="Panel_Content" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataUsers" runat="server"
            ...
            SelectCommand="gral.sp_SolicitudesMes">
            <SelectParameters>
                <asp:Parameter Name="TipoSolicitud" Type="Boolean" DefaultValue="false" />
                <asp:ControlParameter ControlID="cmbMes" PropertyName="Value" Name="Mes" Type="Int32" ConvertEmptyStringToNull="true" />
                <asp:ControlParameter ControlID="cmbAnio" PropertyName="Value" Name="Anio" Type="Int32" ConvertEmptyStringToNull="true" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="dsAnios" runat="server"
            ConnectionString="<%$ ConnectionStrings:connString %>"
            SelectCommand="
     SELECT DISTINCT YEAR(FechaTermino) AS Anio
     FROM V_Solicitudes
     WHERE Id_Estado IN (7) AND FechaTermino IS NOT NULL
     ORDER BY Anio DESC"></asp:SqlDataSource>
        ...
        <dx:ASPxPageControl ID="ASPxPageControl2" runat="server" ActiveTabIndex="0" Width="100%">
            <TabPages>
                ...
                <dx:TabPage Name="Estadistica" Text=" Constancia Final" Visible="true">
                    <%-- <TabImage Url="~/Content/Images/pdf.png">
                    </TabImage>--%>
                    <ContentCollection>

...
namespace SG_Constancia_TSC
{
 ...
 <table style='width:100%; max-width:600px; margin:0 auto; font-family:Segoe UI, sans-serif; background-color:#f9f9f9; padding:20px; color:#333; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);'>
    <tr><td colspan='2' style='text-align:center;'>
        <h2 style='color:#2e7d32; margin-bottom:10px;'>✅ ¡Solicitud recibida!</h2>
    </td></tr>

    <tr><td colspan='2' style='padding:10px 0;'>Para dar seguimiento a su solicitud siga estos pasos:</td></tr>
    ...
    <tr><td colspan='2' style='padding:5px 0;'>2️⃣ Ingrese al portal: <a href='https://www.tsc.gob.hn/' style='color:#d62d20; text-decoration:none;'>www.tsc.gob.hn</a></td></tr>
    <tr><td colspan='2' style='padding:5px 0;'>3️⃣ Vaya a la sección de <strong>Solicitud de Constancias</strong>.</td></tr>
    <tr><td colspan='2' style='padding:5px 0;'>4️⃣ Use el enlace <strong>Seguimiento de solicitud de constancias</strong> e ingrese los datos solicitados.</td></tr>

    <tr><td colspan='2' style='padding:15px 0;'>
        <strong>Número de solicitud:</strong> <span style='color:#d62d20; font-size:16px;'>" + constanciaId + @"</span><br>
        <strong>Clave de seguimiento:</strong> <span style='color:#d62d20; font-size:16px;'>" + randPassword + @"</span>
    </td></tr>


    
</table>";
            string subject = "Solicitud de Constancia Registrada Exitosamente";
            string ccEmail = null;
